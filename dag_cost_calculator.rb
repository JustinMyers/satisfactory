...
@items = YAML.load_file("satisfactory_items.yaml")
@recipes = YAML.load_file("satisfactory_recipes.yaml")
@buildings = YAML.load_file("satisfactory_buildings.yaml")
...
@recipes.each do |recipe|
  recipe[:products].each do |product_name, quantity|
...
@recipes.reject! do |recipe|
  ...
  recipe[:ingredients].each do |ingredient_name, quantity|
